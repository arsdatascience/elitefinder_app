...
export default function Index() {
  ...
  // Exportar análises de qualidade via backend Node.js
  ...
  const handleExportAnalytics = async () => {
    try {
      ...
      console.error('Erro ao exportar análises:', e);
      alert('Falha ao exportar análises. Tente novamente.');
    } finally {
  ...
  // Exportar relatório de vendas via backend Node.js
  ...
  const handleExportSalesReport = async () => {
    try {
      ...
      console.error('Erro ao exportar relatório de vendas:', e);
      alert('Falha ao exportar relatório de vendas. Tente novamente.');
    } finally {
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                {isExportingSalesReport ? (
                  ...
                  <>
                    <span className="hidden sm:inline">Relatório Vendas</span>
